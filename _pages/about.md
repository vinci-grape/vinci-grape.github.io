...
## Peer-Reviewed
- `TOSEM'25`[Abundant Modalities Offer More Nutrients: Multi-Modal-Based Function-level Vulnerability Detection](https://dl.acm.org/doi/pdf/10.1145/3731557)<br>
  Chao Ni, <span style="color: blue;">**Xin Yin\#**</span>, Xiaodan Xu, **TOSEM 2025, CCF-A**
- `CVPR'25`[Reasoning to Attend: Try to Understand How \<SEG\> Token Works](https://arxiv.org/pdf/2412.17741)<br>
  Rui Qian, <span style="color: blue;">**Xin Yin**</span>, Dejing Dou, **CVPR 2025, CCF-A**
- `ICSE'25`[What You See Is What You Get: Attention-based Self-guided Automatic Unit Test Generation](https://arxiv.org/pdf/2412.00828)<br>
  <span style="color: blue;">**Xin Yin**</span>, Chao Ni, Xiaodan Xu, Xiaohu Yang, **ICSE 2025, CCF-A**
- `TSE'24`[Multitask-based Evaluation of Open-Source LLM on Software Vulnerability](https://arxiv.org/pdf/2404.02056)<br>
  <span style="color: blue;">**Xin Yin**</span>, Chao Ni, Shaohua Wang, **TSE 2024, CCF-A**
- `ISSTA'24`[ThinkRepair: Self-Directed Automated Program Repair](https://arxiv.org/pdf/2407.20898)<br>
  <span style="color: blue;">**Xin Yin**</span>, Chao Ni, Shaohua Wang, Zhenhao Li, Limin Zeng, Xiaohu Yang, **ISSTA 2024, CCF-A**
- `FSE'23`[Distinguishing Look-Alike Innocent and Vulnerable Code by Subtle Semantic Representation Learning and Explanation.](https://arxiv.org/pdf/2308.11237)<br>
